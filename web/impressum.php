...
<h1>Datenschutzerklärung</h1><p>Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der Verarbeitung von personenbezogenen Daten (nachfolgend kurz „Daten“) innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie externen Onlinepräsenzen, wie z.B. unser Social Media Profile auf (nachfolgend gemeinsam bezeichnet als „Onlineangebot“). Im Hinblick auf die verwendeten Begrifflichkeiten, wie z.B. „Verarbeitung“ oder „Verantwortlicher“ verweisen wir auf die Definitionen im Art. 4 der Datenschutzgrundverordnung (DSGVO).<br>
    ...
    Nach gesetzlichen Vorgaben in Österreich erfolgt die Aufbewahrung insbesondere für 7 J gemäß § 132 Abs. 1 BAO (Buchhaltungsunterlagen, Belege/Rechnungen, Konten, Belege, Geschäftspapiere, Aufstellung der Einnahmen und Ausgaben, etc.), für 22 Jahre im Zusammenhang mit Grundstücken und für 10 Jahre bei Unterlagen im Zusammenhang mit elektronisch erbrachten Leistungen, Telekommunikations-, Rundfunk- und Fernsehleistungen, die an Nichtunternehmer in EU-Mitgliedstaaten erbracht werden und für die der Mini-One-Stop-Shop (MOSS) in Anspruch genommen wird.</p><p></p><h3 id="dsg-commercialpurpose">Geschäftsbezogene Verarbeitung</h3><p></p><p><span class="ts-muster-content">Zusätzlich verarbeiten wir<br>
        ...
        <br>
        Die von unseren Vertragspartnern angebotene Leistungen können auch auf anderen Webseiten beworben und verlinkt werden (sog. Affiliate-Links). Die Betreiber der jeweiligen Webseiten erhalten eine Provision, wenn Nutzer den Affiliate-Links folgen und anschließend die Angebote wahrnehmen.<br>
        <br>
...
<ol>
    <li>Vertragsgegenstand:
        <ol>
            <li>NSP stellt dem KUNDEN einen Benutzerbereich unter 
                ...
                WEBSERVICE).</li>
            <li>Jedes Installationsprogramm wird anhand der eingepflegten Nutzerdetails
                gemäß den Vorgaben des KUNDEN durch den WEBSERVICE gefertigt.</li>
            <li>Der KUNDE muss für die Nutzung des WEBSERVICE mit den Login-Daten seines
                ...
                KUNDEN.</li>
            <li>Anhand der vom KUNDEN eingepflegten Daten und entweder einem vom KUNDEN
    ...
    <li>Pflichten des KUNDEN
        <ol>
            <li>Der KUNDE ist verpflichtet, keine fremden geschützten Markennamen und
                -logos zu dem WEBSERVICE hochzuladen.</li>
            <li>Der KUNDE hat die Pflicht wahrheitsgemäße Daten in dem WEBSERVICE zu 
                ...
                Nutzer des WEBSERVICE ihre Auswahl über das für sie relevante Installationsprogramm.</li>
    ...
    <li>Haftung von NSP
        <ol>
            <li>Die Ansprüche des KUNDEN auf Schadensersatz oder Ersatz vergeblicher
                Aufwendungen gegen NSP richten sich ohne Rücksicht auf die Rechtsnatur des
                Anspruchs nach diesen Bestimmungen.</li>
            ...
            <li>Für Schäden aus der Verletzung des Lebens, des Körpers oder der
                ...
                Bestimmungen.</li>
            <li>Sofern NSP zumindest fahrlässig eine wesentliche Vertragspflicht, also
                ...
                typischerweise gerechnet werden muss, beschränkt.</li>
            <li>Die Haftung von NSP nach dem Produkthaftungsgesetz (§ 14 ProdHG) bleibt
    ...
    <li>Verfügbarkeit
        <ol>
            <li>Der WEBSERVICE wird als “best effort” Dienst betrieben. NSP sichert 
                keine besondere Verfügbarkeit des WEBSERVICES zu. Es ist von einer 
                Verfügbarkeit des WEBSERVICES von 95% im Jahresmittel auszugehen.</li>
            <li>NSP ist berechtigt, Wartungsarbeiten an dem WEBSERVICE ohne
                Vorankündigung durchzuführen.</li>
            <li>NSP empfiehlt dem Kunden, zusätzlich zur Nutzung des WEBSERVICES auch
                ...
                anzubieten.</li>
            <li>Aus einer Nichtverfügbarkeit des WEBSERVICES von bis zu 3 aufeinanerfolgenden
    ...
    <li>Schlussbestimmungen
        <ol>
            ...
            <li>Es gilt das Recht der Bundesrepublik Deutschland unter Ausschluss des
                UN-Kaufrechts.</li>
            <li>Ist der KUNDE Kaufmann, juristische Person des öffentlichen Rechts
                oder öffentlich-rechtliches Sondervermögen, ist ausschließlicher
                Gerichtsstand für alle Streitigkeiten aus diesem Vertrag der Geschäftssitz
                von NSP in Perl.</li>
            <li>Dasselbe gilt, wenn der KUNDE Unternehmer i.S.d. § 14 BGB ist und
                keinen allgemeinen Gerichtsstand in Deutschland hat oder Wohnsitz oder
                gewöhnlicher Aufenthalt im Zeitpunkt der Klageerhebung nicht bekannt ist.</li>
            <li>Die Befugnis von NSP, auch ein Gericht an einem anderen gesetzlichen
                Gerichtsstand anzurufen, bleibt unberührt.</li>
        </ol>
    </li>
</ol>
</div>
